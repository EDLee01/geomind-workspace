...
// servers (e.g. paper-search-mcp, fred-mcp) into a shared ISOLATED uv env under
// app data (the user's Python is untouched), then register them in Magi's
...
mod tests {
    ...
    fn accepts_real_package_names_and_pins() {
        ...
        assert!(is_safe_package("fred-mcp"));
