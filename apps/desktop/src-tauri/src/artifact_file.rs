...
pub fn mime_for(ext: &str) -> (&'static str, bool) {
    ...
    match ext.to_ascii_lowercase().as_str() {
        ...
        "r" => ("text/x-r", true),
        // Molecular structure formats — plain text; served as utf8 for text preview.
        ...
        // Genome annotation tracks — plain text; served as utf8 for text preview.
...
mod tests {
    ...
    fn genome_and_molecule_files_are_text() {
        // These structure/annotation formats stay utf8 so they preview as text.
