...
5. Literature search · 6. Artifacts/export · 7. Packaging/CI · 8. Climate demo content.
...
3. **Literature review** (shot 3): user message + `StepSummaryRow` + `ToolCallRow` +
   ...
   inspector = `PdfInspector` (review.pdf facsimile). Aligns with the PRD climate/lit-review demo.
