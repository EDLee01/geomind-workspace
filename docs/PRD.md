...
5. Multi-domain — expanding from AI4S to earth science, materials, chemistry,
...
```text
2023–2026 global temperature trends
```
...
- **v0.1 Desktop MVP** — macOS / Windows installers, local workspace, bundled OpenCode runtime,
  ...
  panel, `provenance.jsonl`, basic reviewer, climate demo.
...
- **v0.4 Advanced Science** — more earth-science / materials connectors; RDKit / py3Dmol
  chemical rendering; domain analysis templates; HPC / SSH / Modal runner.
